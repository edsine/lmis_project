...
//         <li><a href="#about">Indicators</a></li>
...
// {/* End Header */}
// {/* ======= Hero Section ======= */}
// <section id="hero" className="hero" style={{backgroundImage: 'url("unsplash_h5xEHzfepNk.png")', backgroundSize: 'cover', display: 'block'}}>
...
//         {/* <img src="used.png" class="img-fluid" alt="" style="opacity: 0.7;" data-aos="zoom-out" data-aos-delay="100"> */}
//       </div>
//     </div>
//   </div>
...
//             <div className style={{fontSize: '21PX', color: 'lightgrey'}}>200M Approximately</div>
//             <hr />
...
//           <div className="icon-box">
//             <div className style={{fontSize: '21PX', color: 'lightgrey'}}>120M Approximately</div>
//             <hr />
...
//           <div className="icon-box">
//             <div className style={{fontSize: '21PX', color: 'lightgrey'}}>7.79%</div>
//             <hr />
...
//           <div className="icon-box">
//             <div className style={{fontSize: '21PX', color: 'lightgrey'}}>35,987</div>
//             <hr />
...
//           <img src="rice.jpg" className="img-fluid rounded-4 mb-4" alt="" />
...
//               <img src="lmis_welcome.png" className="img-fluid rounded-4" alt="" />
...
//             <img src="ndd.jpg" style={{height: '280px', width: '350px'}} className="img-fluid" alt="" />
...
//           <div className="member">
//             <img src="NURHI.jpg" className="img-fluid" style={{height: '280px', width: '350px'}} alt="" />
...
//           <div className="member">
//             <img src="NMIS.jpg" style={{height: '280px', width: '350px'}} className="img-fluid" alt="" />
...
//           <div className="member">
//             <img src="VACS.jpg" style={{height: '280px', width: '350px'}} className="img-fluid" alt="" />
