            ...
            <li className="">
              ...
              <ul className="" style={{ listStyleType: 'none' }}>
                ...
                <li style={{ color: '#488134' }}>
                  <a href="#" style={{ color: 'white' }} className="nav-pills nav-stacked active"><span className="fa-stack fa-lg pull-left "><i className="fa fa-eye fa-stack-1x " /></span>Overview</a>
                </li>
                <li style={{ color: '#488134' }}>
            ...
            <div className="col-12">
              <div className="d-flex flex-wrap">
                <div className="flex-grow-1">
                  <h3 style={{ textalign: 'center' }}>2022 APPROPRIATION AMENDMENT</h3>
                </div>
          ...
          <div className="row">
              ...
              <a href="?category=IT%20%26%20Telecommunication">
                <div className="popular-category-item">
                  ...
                  <div className="popular-category-data">
                    <h6 style={{ color: '#488134' }} >MAIN ENVELOP - PERSONNEL </h6>
            ...
            <div className="col-xl-4 col-lg-4 col-md-6">
              <a href="?category=Others">
                <div className="popular-category-item">
                  ...
                  <div className="popular-category-data">
                    <h6 style={{ color: '#488134' }}>MAIN ENVELOP - OVERHEAD</h6>
            ...
            <div className="col-xl-4 col-lg-4 col-md-6">
              <a href="?category=Others">
                <div className="popular-category-item">
                  <div className="popular-category-icon">
                    <i style={{ color: '#488134' }} className="fas fa-box" />
                  </div>
                  <div className="popular-category-data">
                    <h6 style={{ color: '#488134' }}>CAPITAL DEVELOPMENT FUND</h6>
            ...
            <div className="my-5 col-md-6" >
              <div className='card shadow'>
                <div className="card-body card-body1" style={{ height: '20%' }}>
